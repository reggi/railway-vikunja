import {bucket, defineRailway, image, postgres, preserve, project, service} from 'railway/iac'
...
export default defineRailway(() => {
  ...
  const vikunja = service('vikunja', {
    source: image(`${dockerImages.images.vikunja.repository}:${dockerImages.images.vikunja.tag}`),
    ...
    env: {
      ...
      VIKUNJA_SERVICE_PUBLICURL: 'https://${{RAILWAY_PUBLIC_DOMAIN}}',
